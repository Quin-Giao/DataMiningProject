...
public class RandomForestTuningRaw {
    public static void main(String[] args) throws Exception {
        ...
        ConverterUtils.DataSource source = new ConverterUtils.DataSource("data\\heart_disease_balanced.arff");
        ...
        SerializationHelper.write("models\\RandomForestTuningRaw.model", randomForest);
