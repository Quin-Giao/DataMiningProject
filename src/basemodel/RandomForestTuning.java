...
public class RandomForestTuning {
    public static void main(String[] args) throws Exception {
        ...
        ConverterUtils.DataSource source = new ConverterUtils.DataSource("data\\heart_disease_cleaned.arff");
        ...
        SerializationHelper.write("models\\RandomForest.model", randomForest);
