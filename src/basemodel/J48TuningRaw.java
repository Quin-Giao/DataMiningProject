...
public class J48TuningRaw {
    public static void main(String[] args) throws Exception {
        long startTime = System.nanoTime();

        DataSource trainSource = new DataSource("data\\heart_disease_balanced.arff");
        ...
        SerializationHelper.write("models\\J48TuningRaw.model", j48);
